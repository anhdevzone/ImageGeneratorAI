...
export const stepsData = [
    ...
    },
    {
      ...
      description: 'Công cụ hỗ trợ AI của chúng tôi sẽ biến văn bản của bạn thành hình ảnh độc đáo, chất lượng cao chỉ trong vài giây.',
      icon: step_icon_2,
    },
    {
      title: 'Tải xuống và chia sẻ',
      description: 'Tải xuống ngay tác phẩm của bạn hoặc chia sẻ nó với mọi người trực tiếp từ nền tảng của chúng tôi.',
      icon: step_icon_3,
    },
  ];
